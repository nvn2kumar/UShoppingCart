...
namespace UShoppingCart.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        [ActionName("Summary")]
        public async Task<IActionResult> SummaryPost(ProductUserVM ProductUserVM) //we alredy binded above the product view model So we Dont need to use here as parameter
        {
